...
export const about = {
  paragraphs: [
    "I recently completed my Master's in Urban Data Science at NYU's Center for Urban Science and Progress (CUSP), where I explored how cities work and how we can make them better for everyone.",
    ...
    "Beyond academics, I led the Applied Urban Science Association and the ASPRS NYU Student Chapter, served as a GIS Consultant at NYU Data Services, and worked with the CUSP Education Team to make urban science more accessible.",
  ],
  stats: [
...
export const news: NewsEntry[] = [
  {
    ...
    body: 'Under this role, I lead the club with 250+ members and direct 4 E-board members.I have led the launch of several flagship initiatives. ',
    link: 'https://www.linkedin.com/feed/update/urn:li:activity:7366892066720595969',
    tag: 'Leadership',
  },
  {
    ...
    body: 'Led a workshop with 50+ attendees on how to use and present geospatial data effectively at the 2025 Foundations of Research Computing Camp at NYU.',
  ...
  },
  {
    ...
    month: 'Sept',
    year: '2025',
    headline: 'Founded andChartered the ASPRS NYU Student Chapter - First in the North Atlantic Region',
    body: 'The chapter aims to connect NYU students with cutting-edge geospatial research, industry professionals, and opportunities in the field.',
    link: 'https://community.asprs.org/chapter-nyu/home',
    tag: 'Leadership',
  },
  {
    ...
    body: 'Selected as one of only six graduate students across New York and New Jersey.',
  ...
  },
  {
    ...
    body: 'Placed first in NYU\'s annual GIS Day Mapping Competition, a university-wide contest with over 30 entries from students across disciplines.',
  ...
  },
  {
    ...
    body: 'The event brought together students, faculty, and industry professionals to celebrate the chapter\'s founding and showcase the breadth of geospatial work happening at NYU, setting the tone for the chapter\'s future programming.',
  ...
  },
  {
    ...
    body: 'Transportation Research Board (TRB) Annual Meeting in Washington D.C. - one of the largest transportation research conferences in the world, drawing over 13,000 attendees.',
  ...
  },
  {
    ...
    body: 'Recruited new members and raised awareness about the field of urban data science among incoming and current students.',
  ...
  },
  {
    ...
    body: "Explored the diversity of disciplines under the urban umbrella and the growing role of AI in urban science. Panelists included Becky Duane (Business Development Executive, IBM), Jennifer Pehr AICP MPH WEDG (Urban Strategist & Planner), Jill Lerner (Principal at KPF and Co-chair of the Municipal Art Society of New York), and Kara Emery Ph.D. (Director of Research, AI Hub at NYU McSilver Institute).",
  ...
  },
  {
    ...
    body: "The event invites students and developers to build technology solutions for real city challenges, embodying AUSA's mission to bridge data science and urban impact.",
  ...
  },
  {
    ...
    body: "In recognition of the successful launch and impact of AUSA Career Series and its flagship programs like Code4City, Wisdom Wednesday, Metro Mondays and Women in Urban.",
  ...
  },
  {
    ...
    body: "For my contributions to fostering a collaborative and inclusive environment in urban science and technology.",
    link: '',
    tag: 'Award',
  },
  {
    ...
    month: 'June',
    year: '2026',
    headline: "Named Chair of the Events Subcommittee of GISMO NYC GeoAI Committee",
    body: "Took up responsibility for planning and executing events that promote the use of GeoAI in urban applications in New York City.",
    link: '',
    tag: 'Leadership',
  },
];